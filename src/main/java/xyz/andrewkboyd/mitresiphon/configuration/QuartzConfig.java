...
public class QuartzConfig {
    ...
    @Bean
    public Trigger fetchNVDCVEModifiedTrigger(@Qualifier("fetchNVDCVEModified") JobDetail jobDetails) {
        return TriggerBuilder
                .newTrigger()
                .forJob(jobDetails)
                .withIdentity(NVD_CVE_MODIFIED_JOB_ID)
    ...
    @Bean
    public Trigger fetchNVDCVECompleteTrigger(@Qualifier("fetchNVDCVEComplete") JobDetail jobDetails) {
        return TriggerBuilder
                .newTrigger()
                .forJob(jobDetails)
                .withIdentity(NVD_CVE_COMPLETE_JOB_ID)
